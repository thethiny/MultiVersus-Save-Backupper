...
class SteamAppTicket:
    def __init__(self, app_id: str = ""):
        self.dll_path = os.path.join(os.getcwd(), "steam_api64.dll")
        self.api: WinDLL
        self.h_user = None
        self.h_pipe = None
        self.client = None
        ...
        if app_id:
            try:
                ...
                print(f"Couldn't generate App Id. If steam_appid is open, please close it.")
                exit(1)
    ...
    def _get_interfaces(self):
        ...
        # ISteamUser
        self.api.SteamAPI_ISteamClient_GetISteamUser.argtypes = [c_void_p, c_int, c_int, c_char_p]
        ...
        # ISteamUtils
        self.api.SteamAPI_ISteamClient_GetISteamUtils.argtypes = [c_void_p, c_int, c_char_p]
        ...
        # ISteamFriends
        self.api.SteamAPI_ISteamClient_GetISteamFriends.argtypes = [c_void_p, c_int, c_int, c_char_p]
    ...
    def _define_functions(self):
        self.api.SteamAPI_ISteamUser_GetEncryptedAppTicket.argtypes = [
            c_void_p, c_void_p, c_int, POINTER(c_uint32)
        ]
        ...
        self.api.SteamAPI_ISteamUtils_IsAPICallCompleted.argtypes = [
            c_void_p, c_uint64, POINTER(c_bool)
        ]
    ...
    def get_encrypted_app_ticket(self,): #, data=None):
        buf_size = 2048
    ...
    def request_and_wait_for_encrypted_app_ticket(self, data: bytes = b""):
        ...
        result_struct = self.wait_for_call_result(
            request_id, EncryptedAppTicketResponse_t, sizeof(EncryptedAppTicketResponse_t),
        )
    ...
    def wait_for_call_result(self, call_id, callback_type: Type[Structure], struct_size=32, poll_interval=0.5):
        ...
        while not self.api.SteamAPI_ISteamUtils_IsAPICallCompleted(self.utils, call_id, byref(io_failure)):
        ...
        if not success or io_failure.value:
            raise RuntimeError("SteamAPI_GetAPICallResult failed or IO failure occurred")
